...
def Get():
	...
	m3u  = 'http://thedab.xyz:80/get.php?username='+username+'&password='+password+'&type=m3u_plus&output=ts'
	epg  = 'http://thedab.xyz:80/xmltv.php?username='+username+'&password='+password
	auth = 'http://thedab.xyz:80/enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
